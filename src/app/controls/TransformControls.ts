...
THREE.TransformControls = function ( camera: any, domElement: any ) {
	...
	var mouseDownEvent: any = { type: "mouseDown" };
	...
	function defineProperty( propName: any, defaultValue: any ) {
	...
	this.pointerMove = function ( pointer: any ) {
	...
	this.pointerUp = function ( pointer: any ) {
	...
	function onPointerHover( event: any ) {
	...
	this.setMode = function ( mode: any ) {

		scope.mode = mode;

	};

	this.setTranslationSnap = function ( translationSnap: any ) {

		scope.translationSnap = translationSnap;

	};

	this.setRotationSnap = function ( rotationSnap: any ) {

		scope.rotationSnap = rotationSnap;

	};

	this.setScaleSnap = function ( scaleSnap: any ) {
	...
	this.setSpace = function ( space: any ) {
...
THREE.TransformControlsGizmo = function () {
	...
	var CircleGeometry = function ( radius: any, arc: any ) {
	...
	var setupGizmo = function ( gizmoMap: any ) {
	...
	this.updateMatrixWorld = function () {
		...
		for ( var i = 0; i < handles.length; i ++ ) {
			...
			if ( ! this.enabled ) {
				...
				} else if ( this.axis.split( '' ).some( function ( a: any ) {
